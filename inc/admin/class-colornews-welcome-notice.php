		...
		<div id="message" class="notice notice-success colornews-notice">
			...
			<div class="colornews-message__content">
				<div class="colornews-message__image">
					<img class="colornews-screenshot" src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.jpg" alt="<?php esc_attr_e( 'ColorNews', 'colornews' ); ?>" /><?php // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped, Squiz.PHP.EmbeddedPhp.SpacingBeforeClose ?>
				</div>
				...
				<div class="colornews-message__text">
					...
					<div class="colornews-message__cta">
						...
						<span class="plugin-install-notice"><?php esc_html_e( 'Clicking the button will install and activate the ThemeGrill demo importer plugin.', 'colornews' ); ?></span>
					</div>
				</div>
			</div>
