...
/**
 * ColorNews_Demo_Importer Class.
 */
class ColorNews_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'colornews' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'colornews' ), __( 'Demo Importer', 'colornews' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
